...
<div class="header">
    ...
    <h2>
        <a href="/user?action=create">Add New House</a>
    </h2>
</div>
<div class="">
    <div class="" align="center">
        <table border="1" cellpadding="5">
            <caption><h2>List of Houses</h2></caption>
            <tr>
                <th>ID</th>
                <th>Name</th>
                <th>Email</th>
            ...
            <c:forEach var="house" items="${listHouse}">
                <tr>
                    ...
                    <td><c:out value="${house.country}"/></td>
                    <td>
        ...
        <form method="post" action="" >
            <input class="search " placeholder="name"  type="text" name="name" id="search">
